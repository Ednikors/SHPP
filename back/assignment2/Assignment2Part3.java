...
public class Assignment2Part3 extends WindowProgram {
    ...
    private void drawPartOfPawPrint(double posX, double posY, double width, double height) {
        // Scale coefficient for x-dimension
        double widthScaleCoeff = (double) getWidth() /APPLICATION_WIDTH;
        // Scale coefficient for y-dimension
        double heightScaleCoeff = (double) getHeight() /APPLICATION_HEIGHT;
        GOval oval = new GOval(posX*widthScaleCoeff, posY*heightScaleCoeff,
                width*widthScaleCoeff, height*heightScaleCoeff); // Draw oval
